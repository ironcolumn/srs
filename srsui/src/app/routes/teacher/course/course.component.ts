...
@Component ( {
  selector : "app-teacher-course" , templateUrl : "./course.component.html" ,
} )
export class TeacherCourseComponent implements OnInit {
  ...
  columns : SimpleTableColumn[] = [ { title : "编号" , index : "courseSn" } ,
                                    { title : "课程名" , index : "courseName" } ,
                                    { title : "学分" , index : "credit" } ,
                                    { title : "先修课程" , index : "prevCoursesString" } ,
                                    {
                                      title   : "" ,
                                      buttons : [ { text : "编辑" , type : "none" , click : ( record ) => this.edit ( record ) } ,
